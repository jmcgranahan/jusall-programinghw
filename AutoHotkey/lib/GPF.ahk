...
GPF_SetSingleLine(ObjNum,PosX,PosY,Text,ARGB,UseBlackBG,FontSize,UseBold,FontFamily)
{
  ...
  DllCall(proc_GPSL_SetTextLineData, UChar, ObjNum, "UShort", PosX, "UShort", PosY, "str", GPF_AuxGetFilledStr(Text), "UInt", ARGB, "Int", UseBlackBG, "UChar", FontSize, "Int", UseBold, "UChar", FontFamily)
  return ErrorLevel
}
...
GPF_SetMultiLine(ObjNum,PosX,PosY,Text,ARGB,UseBlackBG,FontSize,UseBold,SizeX,SizeY,FontFamily)
{
  ...
  DllCall(proc_GPML_SetTextMultilineData, UChar, ObjNum, "UShort", PosX, "UShort", PosY, "str", GPF_AuxGetFilledStr(Text), "UInt", ARGB, "Int", UseBlackBG, "UChar", FontSize, "Int", UseBold, "UChar", SizeX, "UChar", SizeY, "UChar", FontFamily)
  return ErrorLevel
}
